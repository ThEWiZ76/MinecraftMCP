...
Inventory and screen item stacks include item id, count, display/custom names, damage, lore, data components, custom data/NBT, and encoded/saved item NBT when available.
